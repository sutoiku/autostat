...
# from autostat.tests.PERnc_testValuesAndGrads import PERnc_testValuesAndGrads as testVals


# class TestGradients:
#     @pytest.mark.parametrize("param_init_val", testVals[:10])
#     def test_grad_length_scale_finite_diff(self, param_init_val):
#         param = "length_scale"
#         mat_slice = 0
...
class TestGradientsFiniteDiff:
    ...
    def test_grad_periodicity_finite_diff(self, param_init_val):
        param = "periodicity"
        mat_slice = 1
